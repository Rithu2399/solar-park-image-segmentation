...
DATA_ROOT = "/mnt/d/Master Thesis/Implementation/DATA_SET_RP/Solar_Panel_detection.v1i.coco-segmentation_Final" # Give the exact path of Coco format dataset "Solar_Panel_detection.v1i.coco-segmentation"
IMG_SIZE  = 512
BATCH     = 4
EPOCHS    = 30
LR        = 5e-5
...
def build_model():
    ...
    sd_pre = torch.load("/mnt/d/Master Thesis/Implementation/PSC-Image-Segmentation-Complete-Pipeline/saved_models/u2net/u2net.pth", map_location="cpu") # Generated by ruuning the python3 U2NET/setup_model_weights.py  module 
